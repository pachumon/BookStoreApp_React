...
const useBookActionsHandler = (props) => {
  ...
  return { defaultState, bookInfo };
};

const BookActions = props => {
  const container = useRef(null);
  const { defaultState, bookInfo } = useBookActionsHandler(props);
              ...
              {({
                ...
                <>
                  <form className="form-horizontal" onSubmit={handleSubmit}>
                    ...
                    <div
                      className={`form-group ${errors.published !== undefined &&
                    ...
                    <div
                      className={`form-group ${errors.category !== undefined &&
